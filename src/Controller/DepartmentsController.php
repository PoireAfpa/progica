...
class DepartmentsController extends AbstractController
{
    ...
    #[Route('/{code}', name: 'app_departments_show', methods: ['GET'])]
    ...
    #[Route('/{code}/edit', name: 'app_departments_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/{code}', name: 'app_departments_delete', methods: ['POST'])]
    public function delete(Request $request, Departments $department, DepartmentsRepository $departmentsRepository): Response
    {
        if ($this->isCsrfTokenValid('delete'.$department->getCode(), $request->request->get('_token'))) {
